...
const Installation = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto my-10">
      ...
      <div className="my-7">
        {sortedItem().map((p) => (
          <div key={p.id} className="card flex p-5 mt-10 justify-between items-center card-side bg-base-300 shadow-sm">
            <div className="flex gap-5 justify-center items-center">
              ...
              <div className=" flex  gap-3  items-center">
                ...
                <div className=" flex gap-1 justify-center items-center">
                  ...
                  <p className=" font-medium text-[13px]">{p.ratings.length}</p>
                </div>
                <div>
            ...
            <div className="">
              <button onClick={() => handleRemove(p.id)} className="btn  bg-[#00D390] ">Uninstalled</button>
            </div>
          </div>
        ))}
      </div>
